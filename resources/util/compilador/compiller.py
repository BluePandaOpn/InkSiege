...
class LegendsCompiler(QWidget):
    def __init__(self):
        ...
        self.version_file = os.path.join(self.project_root, "version_control.json")
    ...
    def initUI(self):
        self.setWindowTitle("Cads Legends - Ultra Compiler & Versioning")
        ...
        self.input_icon = self.create_input(file_layout, "Icono (.ico):", "resources/assets/logo/logo.ico")
        self.input_assets = self.create_input(file_layout, "Carpeta Resources:", "resources")
    ...
    def find_project_root(self):
        ...
        while True:
            if os.path.exists(os.path.join(cur, "main.py")) and os.path.isdir(os.path.join(cur, "resources")):
                return cur
    ...
    def set_project_defaults(self):
        # Intentar auto-detectar rutas desde la raiz del proyecto
        base = self.project_root
        main_path = os.path.join(base, "main.py")
        if os.path.exists(main_path):
            self.input_main.setText(main_path)
            
        resources_path = os.path.join(base, "resources")
        if os.path.exists(resources_path):
            self.input_assets.setText(resources_path)
        icon_path = os.path.join(base, "resources", "assets", "logo", "logo.ico")
        if os.path.exists(icon_path):
            self.input_icon.setText(icon_path)
    ...
    def run_process(self):
        ...
        # Resources automaticos (incluye assets/lang/docs/util)
        resources_path = self.input_assets.text()
        if os.path.exists(resources_path):
